...
const sendEmailBox = async (email, otpdata) => {
  try {
    sgMail
      .send({
        to: email,
        bcc: 'ajchaudharyjat00@gmail.com',
        from: 'panchalvikas292000@gmail.com',
        subject: 'Transport Guru send Otp ',
        html: `
          <html
                                              ...
                                              "
                                                        ...
                                                        >
                                                          <img
                                                            align="center"
                                                            border="0"
                                                            src="https://firebasestorage.googleapis.com/v0/b/transportguru-631cd.appspot.com/o/icon.png?alt=media&token=9da97f16-9b37-4f11-9d3f-93bcf1d140ca"
                                                            alt="Image"
                                                            title="Image"
                                                            style="
                                                  outline: none;
                                ...
                                "
                                        ...
                                        "
                                          ...
                                          "
                                              ...
                                              "
                                                        >Verification code is valid only for 60
                                                          second
                                                        </span>
                                                      </p>
                                                    </div>
