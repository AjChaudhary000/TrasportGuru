...
const TrackingDetails = props => {
    ...
    const paymentHendle = item => {
        ...
        var options = {
            ...
            name: props.trackingDetails[0]?.tarsportId?.tarsportUserId
                .trasportAccount[0].trasportName,
            prefill: {
                        ...
                        <View style={styles.listBox(props)}>
                            <View
                                ...
                                <View style={{ width: '20%', justifyContent: 'center' }}>
                                    <View style={styles.image(props)}>
                                        <Image
                                            ...
                                            source={{
                                                uri: item.item.tarsportId?.tarsportUserId
                                                    .trasportAccount[0].trasportImage,
                                            }}
                                        />
                                    </View>
                                </View>
                                <View
                                    ...
                                    <Text
                                        ...
                                        {
                                            item.item.tarsportId.tarsportUserId.trasportAccount[0]
                                                .trasportName
                                        }
                                    </Text>
                                </View>
                                <View
                                    ...
                                    <TouchableOpacity
                                        style={{ width: '50%' }}
                                        onPress={() =>
                                            CallBtn(item.item?.tarsportId?.tarsportUserId.mobileno)
                                        }>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            ...
                                            if (
                                                item.item?.tarsportId.tarsportUserId._id ===
                                                props.userData._id
                                            ) {
                                                ...
                                                props.navigation.navigate('ChatDetails', {
                                                    item: item.item?.tarsportId?.tarsportUserId,
                                                });
                                            }
                                        }}>
                            ...
                            <View
                                ...
                                <Text style={{ fontWeight: 'bold', color: 'gray' }}>
                                    Truck Reg No :{' '}
                                    {item.item?.tarsportId.truckId.truckRegistartionNo}
                                </Text>
                                <Text style={{ fontWeight: 'bold', color: 'gray' }}>
                                    Driver Name : {item.item?.tarsportId.driverId.driverName}
                                </Text>
                                <View
                                    style={{
                                        flexDirection: 'row',
                                    ...
                                    <View style={{ width: '90%' }}>
                                        <Text style={{ fontWeight: 'bold', color: 'gray' }}>
                                            Driver Mobile no :{' '}
                                            {item.item?.tarsportId.driverId.driverMobileNo}
                                        </Text>
                                    </View>
                                    <TouchableOpacity
                                        style={{ width: '10%' }}
                                        onPress={() =>
                                            CallBtn(item.item?.tarsportId.driverId.driverMobileNo)
                                        }>
                                        <Image
                                            source={icons.call}
                                            style={{
                            ...
                            <View
                                ...
                                <View>
                                    <Text
                                        ...
                                        {new Date(new Date(item.item.createdAt)).toLocaleDateString(
                                            'en-US',
                                ...
                                <View>
                                    <Text
                                        ...
                                        {new Date(new Date(item.item.createdAt))
                            ...
                            <View
                                ...
                                <View style={{ width: '40%', alignItems: 'center' }}>
                                    <Text
                                        ...
                                        {
                                            item.item.paymentid.destination.name
                                                .split(',')
                                                .reverse()[2]
                                        }
                                    </Text>
                            ...
                            <View
                                ...
                                <View style={{ width: '50%', alignItems: 'center' }}>
                                    ...
                                    <Text
                                        ...
                                        {Math.round(
                                            calcKmFind(
                                                item.item.paymentid.from.lat,
                                                item.item.paymentid.from.lng,
                                                item.item.paymentid.destination.lat,
                                                item.item.paymentid.destination.lng,
                                            ) / 45,
                                        )}{' '}
                                        hrs{' '}
                                    </Text>
                            ...
                            <View
                                ...
                                <View style={{ width: '3%', alignItems: 'flex-end' }}>
                                    <Image
                                        ...
                                        style={{
                                            ...
                                            height:
                                                50 *
                                                (item.item.tarsportId.routeId.routeStop.length + 2),
                                            tintColor: props.theme
                                                ? color.drakPrimaryColors
                                                : color.primaryColors,
                                        }}
                                ...
                                <View
                                        ...
                                        <View style={{ margin: 5, flexDirection: 'row' }}>
                                            <View style={{ width: '5%', justifyContent: 'center' }}>
                                                <Image
                                                    ...
                                                    style={{
                                                        ...
                                                        height: 20,
                                                        tintColor:
                                                            new Date(item.item.tarsportId.Truckdate) <=
                                                                new Date()
                                                                ? 'green'
                                                                : color.primaryColors,
                                                    }}
                                            ...
                                            <View style={{ width: '95%' }}>
                                                <Text
                                                    ...
                                                    {item.item.tarsportId.routeId.from.name}
                                                </Text>
                                            </View>
                                        </View>
                                        <View
                                            ...
                                            <View style={{ alignItems: 'center' }}>
                                                <Text
                                                    ...
                                                    {new Date(
                                                        item.item.tarsportId.Truckdate,
                                                    ).toLocaleDateString('en-US', {
                                                        weekday: 'short',
                                                        month: 'long',
                                                        day: 'numeric',
                                    ...
                                    {(item.item.tarsportId?.routeId?.routeStop).map(
                                        (data, index) => (
                                            <View key={index}>
                                                <View style={{ margin: 5, flexDirection: 'row' }}>
                                                    <View style={{ width: '5%', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ margin: 5, flexDirection: 'row' }}>
                                                        ...
                                                        tintColor:
                                                            new Date(
                                                                new Date(
                                                                    ...
                                                                    item.item.tarsportId.routeId.destination
                                                                        .avgTime,
                                                                ),
                                                            ) <= new Date()
                                                                ? 'green'
                                            ...
                                            <View style={{ width: '95%' }}>
                                                <Text
                                                    ...
                                                    {item.item.tarsportId.routeId.destination.name}
                                                </Text>
                                            </View>
                                        </View>
                                        <View
                                            ...
                                            <View style={{ alignItems: 'center' }}>
                                                <Text
                                                    ...
                                                    {new Date(
                                                        new Date(item.item.tarsportId.Truckdate).setHours(
                                                            new Date(
                                                                item.item.tarsportId.Truckdate,
                                                            ).getHours() +
                                                            item.item.tarsportId.routeId.destination
                            ...
                            <View
                                ...
                                <View>
                                    ...
                                    <Text
                                        ...
                                        {new Date(
                                            new Date(item.item.tarsportId.Truckdate).setHours(
                                                new Date(item.item.tarsportId.Truckdate).getHours() +
                                                Math.round(
                                                    calcKmFind(
                                                        item.item.paymentid.from.lat,
                                                        item.item.paymentid.from.lng,
                        ...
                        <View style={{ marginHorizontal: 20 }}>
                            {(item.item?.paymentid?.paymentHistory).map((data, index) => (
                                <View
                                    ...
                                    <View style={{ width: '5%' }}>
                                        <Text
                                            style={{ color: 'gray', fontWeight: 'bold', fontSize: 14 }}>
                                            {index + 1})
                                        </Text>
                                    </View>
                                    <View style={{ width: '55%' }}>
                                    ...
                                    <View style={{ width: '40%' }}>
                                        <Text
                                            ...
                                            {new Date(new Date(data.paymentDate)).toLocaleDateString(
                                                'en-US',
                                                {
                                                    weekday: 'short',
                                                    month: 'long',
