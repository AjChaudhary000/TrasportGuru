            ...
            <ScrollView
                ...
                <View style={styles.image(props)}>
                    <Image
                        ...
                        source={{
                            uri: props.route.params.item.trasportAccount[0].trasportImage,
                        }}
                    />
                </View>
                ...
                <View
                    ...
                    <TouchableOpacity
                        style={{ width: '33%' }}
                        onPress={() =>
                            CallBtn(props.route.params.item.trasportAccount[0].trasportmobile)
                        }>
                ...
                <View style={styles.body}>
                    ...
                    <Text style={{ fontSize: 14, fontWeight: 'bold', color: 'gray' }}>
                        {props.route.params.item.trasportAccount[0].trasportAddress}
                    </Text>
                </View>
            </ScrollView>
        </View>
