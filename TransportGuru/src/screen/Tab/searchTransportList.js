                    ...
                    renderItem={item => (
                        <View style={styles.listBox(props)}>
                            <View
                                ...
                                <View
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            Linking.canOpenURL(
                                                `tel:${item.item.tarsportUserId.trasportAccount[0].trasportmobile}`,
                                            );
                                        }}>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            if (
                                                item.item?.tarsportUserId._id === props.userData._id
                                            ) {
                            ...
                            <View
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        setRoute({ type: true, id: item.item.routeId._id }),
                                            setModalVisible(true);
                                    }}>
                                    <Text
                                        style={{ color: color.primaryColors, fontWeight: 'bold' }}>
                                        Routes
                                    </Text>
                                </TouchableOpacity>
                                <View>
                            ...
                            {/* route data */}
                            {route.id === item.item.routeId._id && (
                                <DialogBox
