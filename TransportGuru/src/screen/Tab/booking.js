...
const Booking = props => {
  ...
  React.useEffect(() => {
    props.transportListById({
      id: props.route.params.tarsportId,
      token: props.token,
    });
  }, []);
  ...
  const paymentHendle = (price, truckCapicty) => {
    const totalPayment =
      calcKmFind(
        ...
        props.route.params.destination.lng,
      ) *
      props.route.params.capicity *
      price;
    let paymentStatus = '';
    ...
    const totalCapicity =
      Number(props.route.params.capicity) + Number(truckCapicty);
    ...
    var options = {
      ...
      name: props.transportList[0]?.tarsportUserId.trasportAccount[0]
        .trasportName,
      prefill: {
    ...
    RazorpayCheckout.open(options)
      .then(res => {
        ...
        props.updateTransport({
          data: { capicity: totalCapicity },
          id: props.route.params.tarsportId,
          token: props.token,
        });
          ...
          <View style={styles.listBox(props)}>
            <View
              ...
              <View style={{ width: '20%', justifyContent: 'center' }}>
                <View style={styles.image(props)}>
                  <Image
                    ...
                    source={{
                      uri: item.item.tarsportUserId.trasportAccount[0]
                        .trasportImage,
                    }}
                  />
                </View>
              ...
              <View
                ...
                <Text
                  ...
                  {item.item.tarsportUserId.trasportAccount[0].trasportName}
                </Text>
              </View>
              <View
                style={{
            ...
            <View
              ...
              <View style={{ width: '3%', alignItems: 'flex-end' }}>
                <Image
                  ...
                  style={{
                    width: 5,
                    height: 50 * (item.item.routeId.routeStop.length + 2),
                    tintColor: props.theme
                      ? color.drakPrimaryColors
                      : color.primaryColors,
                  }}
                  ...
                  <View
                    ...
                    <View style={{ alignItems: 'center' }}>
                      <Text
                        ...
                        {new Date(item.item.Truckdate).toLocaleDateString(
                          'en-US',
                    ...
                    <View style={{ alignItems: 'center' }}>
                      <Text
                        ...
                        {new Date(
                          new Date(item.item.Truckdate).setHours(
                            new Date(item.item.Truckdate).getHours() +
                            item.item.routeId.destination.avgTime,
                          ),
                        ).toLocaleDateString('en-US', {
                          weekday: 'short',
                          month: 'long',
            ...
            <View style={{ marginVertical: 5, marginHorizontal: 10 }}>
              ...
              <RadioButtonRN
                ...
                selectedBtn={e => {
                  setAmount(e.amount), setModalVisible1(true);
                }}
                boxStyle={{
            ...
            <Modal
              ...
              <View style={styles.modelBox1(props)}>
                ...
                <TouchableOpacity
                  ...
                  style={{ alignItems: 'center', bottom: 30, right: 5 }}>
                  <Image
                    source={icons.close}
                    style={{
                      width: 35,
