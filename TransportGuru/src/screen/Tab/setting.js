...
import { getUserDetails, setUserData } from '../../Redux/UserDetails';
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Image
            ...
            source={{
              uri:
                ...
                'https://firebasestorage.googleapis.com/v0/b/trasnsportguru.appspot.com/o/user%2Fuser.jpg?alt=media&token=69b96dfc-7eec-4402-9f61-f6f53d0c0c7e',
            }}
          />
        </View>
        ...
        <View style={styles.menu}>
          <View style={{ marginTop: 30, marginBottom: 30 }}>
            ...
            <SettingMenu
              icon={icons.truck}
              menuName={'Transport Guru Account'}
              onPress={() => {
                props.navigation.navigate('TrasportGuruAccount', {
                  type: props.userData?.accountType,
                });
              }}
            />
            ...
            <TouchableOpacity
              ...
              <View style={styles.menuIcon}>
                <Image
                  source={icons.contrast}
                  style={styles.menuiconStyle(props)}
                />
              </View>
              ...
              <View style={styles.menuclick}>
                <Switch
                  trackColor={{
                    false: '#767577',
                    true: `${color.primaryColors}11`,
                  }}
                  thumbColor={
                    isEnabled ? color.primaryColors : color.primaryColors
                  }
