                    ...
                    <View style={{ flex: 1, justifyContent: 'center' }}>
                        <View style={styles.modelBox(props)}>
                            <Text style={{ color: 'red', fontWeight: 'bold' }}>
                                *Note :- Truck calculation{' '}
                            </Text>

                            <Text style={{ color: 'red', fontWeight: 'bold' }}>
                                * Ex: 10 Km , 10 Tonne , Price 10,{' '}
                            </Text>
                            <Text style={{ color: 'gray', fontWeight: 'bold' }}>
                                {' '}
                                totalPrice = Price * Tonne * Km{' '}
                            </Text>
                            <Text style={{ color: 'gray', fontWeight: 'bold' }}>
                                {' '}
                                1000 = 10 * 10 * 10{' '}
                            ...
                            <Text style={{ color: 'red', fontWeight: 'bold' }}>
                                calculated on the basis of minimum distance and weight.
                            </Text>
                        </View>
                        <TouchableOpacity
                            onPress={() => {
                        ...
                        <KeyboardAwareScrollView
                            ...
                            <View
                                ...
                                <View style={{ width: '85%' }}>
                                    <Text style={styles.input(props)}>
                                        {data.Truckdate ? data.Truckdate : 'Date'}
                                    </Text>
                                </View>
                                <TouchableOpacity
                            ...
                            <View style={{ marginHorizontal: 10, marginVertical: 20 }}>
                                <TouchableOpacity
                                    ...
                                    <Text style={styles.btnText}>Add Transport Details</Text>
                                </TouchableOpacity>
                            </View>
                        </KeyboardAwareScrollView>
                    </View>
                        ...
                        <KeyboardAwareScrollView
                            ...
                            <View style={{ marginHorizontal: 10, marginVertical: 20 }}>
                                <TouchableOpacity
                                    ...
                                    <Text style={styles.btnText}>Update Transport Details</Text>
                                </TouchableOpacity>
                            </View>
                        </KeyboardAwareScrollView>
                    </View>
