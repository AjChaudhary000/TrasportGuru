                    ...
                    renderItem={item => (
                        <View style={styles.listBox(props)} key={'A' + item.index}>
                            ...
                            <View
                                ...
                                <View>
                                    <Text style={{ color: 'gray', fontWeight: 'bold' }}>
                                        {new Date(item.item.Truckdate).toLocaleDateString('en-US', {
                                            weekday: 'long',
                                            year: 'numeric',
                                            month: 'long',
                                            day: 'numeric',
                            ...
                            <View
                                ...
                                <View>
                                    <Text
                                        ...
                                        {item.item.capicity}/{item.item.truckId.truckCapicity}
                                    </Text>
                                </View>
                                <View>
                                    <Text style={{ color: 'gray', fontWeight: 'bold' }}>
                                        {item.item.truckId.truckCapicity - item.item.capicity}{' '}
                                        Available
                                    </Text>
                                </View>
                            </View>
                            <View
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        setDriver({ type: true, id: item.item._id });
                                    }}>
                                    <Text
                                        style={{
                                            color: props.theme
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        setTruck({ type: true, id: item.item._id });
                                    }}>
                                    <Text
                                        style={{
                                            color: props.theme
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        setRoute({ type: true, id: item.item._id });
                                    }}>
                                    <Text
                                        style={{
                                            color: props.theme
                                ...
                                <DialogBox
                                    ...
                                    <View style={styles.drivelist}>
                                        <View style={styles.image(props)}>
                                            <Image
                                                source={{ uri: item.item.driverId.driverImage }}
                                                style={{
                                                    width: '100%',
                                                    height: '100%',
                                                    overflow: 'hidden',
                                        ...
                                        <View style={styles.listData}>
                                            <Text style={styles.driverName(props)}>
                                                {item.item.driverId.driverName}
                                            </Text>
                                            <Text style={styles.driverEmail}>
                                                {item.item.driverId.driverEmail}
                                            </Text>
                                            <Text style={styles.driverMobileNo(props)}>
                                                {item.item.driverId.driverMobileNo}
                                            </Text>
                                        </View>
                                    </View>
                                </DialogBox>
                            ...
                            {truck.id === item.item._id && (
                                <DialogBox
                                    ...
                                    <View style={styles.drivelist}>
                                        <View style={styles.image(props)}>
                                            <Image
                                                source={{ uri: item.item.truckId.truckImage }}
                                                style={{
                                                    width: '100%',
                                                    height: '100%',
                                                    overflow: 'hidden',
                                        ...
                                        <View style={styles.listData}>
                                            <Text style={styles.truckname(props)}>
                                                {item.item.truckId.truckName}
                                            </Text>
                                            <Text style={styles.truckmodelname(props)}>
                                                {item.item.truckId.truckModelName}
                                            </Text>
                                            <View
                                                style={{
                                                    flexDirection: 'row',
                                                ...
                                                <Text style={styles.truckreg}>
                                                    {item.item.truckId.truckRegistartionNo}
                                                </Text>
                                                <Text style={styles.truckcapicity(props)}>
                                                    {item.item.truckId.truckCapicity} /-Tonnes
                                                </Text>
                                            </View>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <View style={{ width: '5%', justifyContent: 'center' }}>
                                            <Image
                                                ...
                                                style={{
                                                    width: 10,
                                                    height: 40 * item.item.routeId.routeStop.length,
                                                    tintColor: props.theme
                                                        ? color.drakAdminprimaryColors
                                                        : color.adminprimaryColors,
                                                }}
                                        ...
                                        <View style={{ width: '95%', justifyContent: 'center' }}>
                                            <FlatList
                                                data={item.item.routeId.routeStop}
                                                renderItem={item => (
