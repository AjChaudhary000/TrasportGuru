...
const AdminEditAccount = props => {
    const [firebaseImage, setfirebaseImage] = React.useState(
        props.route.params.item.trasportAccount[0].trasportImage || '',
    );
    ...
    const [data, setData] = React.useState({
        ...
        trasportAddress:
            props.route.params.item?.trasportAccount[0].trasportAddress || 'Address',
        trasportmobile:
            props.route.params.item?.trasportAccount[0]?.trasportmobile || '',
    });
    React.useEffect(() => {
    ...
    const EditAccount = () => {
        if (data.trasportName === '') {
            ...
            props.usereditAccount({
                data: { trasportAccount: [{ ...data, trasportImage: firebaseImage }] },
                ...
                <View style={{ marginHorizontal: 10 }}>
                    {!imageLoading ? (
                        ...
                        <View
                            ...
                            <LottieView
                                source={require('../../assets/json/uploading1.json')}
                                autoPlay
                                loop
                            />
                        </View>
