...
import {
    ...
    setTruckData,
    updateTruck,
} from '../../Redux/Admin/addTruckSlice';
...
const AddTruck = props => {
    const [firebaseImage, setfirebaseImage] = React.useState(
        props.route.params?.item?.truckImage || '',
    );
    ...
    const renderItem = item => {
        return (
            <View style={styles.item(props)}>
                ...
                <Image
                    source={image[item.truckTypeImage]}
                    ...
                    <KeyboardAwareScrollView
                        ...
                        <View style={{ margin: 10 }}>
                            <TextInput
                                ...
                                placeholderTextColor={'gray'}
                                onChangeText={val =>
                                    setData({ ...data, truckRegistartionNo: val })
                                }
                                autoCapitalize={'none'}
                            />
                        </View>
                        ...
                        <View style={{ marginHorizontal: 10, marginVertical: 20 }}>
                            <TouchableOpacity
                                ...
                                <Text style={styles.btnText}>Update Truck</Text>
                            </TouchableOpacity>
                        </View>
                    </KeyboardAwareScrollView>
                </ScrollView>
