...
const BookingHistory = props => {
    ...
    // }, []);
    React.useEffect(() => {
        props.trackingDetailsByTransportId({
            token: props.token,
                        ...
                        <View style={styles.listBox(props)}>
                            ...
                            <View
                                ...
                                <View
                                    ...
                                    <View style={{ width: '90%' }}>
                                        <Text style={{ fontWeight: 'bold', color: 'gray' }}>
                                            {item.item?.userId?.mobileno || '+91'}
                                        </Text>
                                    </View>
                                    <TouchableOpacity
                                        style={{ width: '10%' }}
                                        onPress={() => CallBtn(item.item?.userId?.mobileno)}>
                                        <Image
                                            source={icons.call}
                                            style={{
                                                width: 20,
...
const useDispatch = dispatch => {
    return {
        trackingDetailsByTransportId: data =>
            dispatch(trackingDetailsByTransportId(data)),
    };
};
