...
const AdminHome = props => {
    ...
    const onRefresh = React.useCallback(() => {
        ...
        props.getCountRoute(props.token), props.getCountTransport(props.token);
        ...
        <View style={styles.container(props)}>
            ...
            <ScrollView
                ...
                <View style={styles.box}>
                    <TouchableOpacity
                        style={styles.adminCard(props)}
                        activeOpacity={0.8}
                        onPress={() => props.navigation.navigate('TruckList')}>
                ...
                <View style={styles.box}>
                    <TouchableOpacity
                        style={styles.adminCard(props)}
                        activeOpacity={0.8}
                        onPress={() => props.navigation.navigate('Routelist')}>
                        <View style={styles.Text}>
                    ...
                    <TouchableOpacity
                        style={styles.adminCard(props)}
                        activeOpacity={0.8}
                        onPress={() => props.navigation.navigate('TransportListDetails')}>
                        <View style={styles.Text}>
                            <Text style={styles.menuText(props)}>{props.countTransport}</Text>
                        </View>
                        <View style={styles.icon}>
                            <Image
                                source={icons.addtotruck}
                                style={{
                                    width: 40,
                                    height: 40,
                                    tintColor: color.adminprimaryColors,
