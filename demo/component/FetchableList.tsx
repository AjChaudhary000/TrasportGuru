...
import {IProps, IState} from '../components/FetchableList/FetchableList_Types';
...
export default class FetchableList extends Component<IProps, IState> {
  ...
  fetchFirstTime = () => {
    ...
    const endpoint: string | undefined = this.getEndpoint(page);
    endpoint &&
  ...
  render() {
    ...
    const refreshing: boolean | undefined | null = refreshEnable
